...
int block::bknew()
{
    ...
    case 0:///I
        ...
        this->nowblock.points[0]= { 1, 0, 0 };
        this->nowblock.points[1]= { 0, 0, 0};
        this->nowblock.points[2]= { -1, 0, 0};
    ...
    case 1:///L
        ...
        this->nowblock.points[0]= { 1, 0, 0};
        this->nowblock.points[1]= { 0, 0, 0};
        this->nowblock.points[2]= { 0, 0, 1};
        this->nowblock.color=0xffffff;
        break;
    case 2:///O
        this->nowblock.numofbk=4;
        this->nowblock.points[0]= { 1, 0, 0};
        this->nowblock.points[1]= { 1, 0, -1};
        this->nowblock.points[2]= { 0, 0, 0};
        this->nowblock.points[3]= { 0, 0, -1};
        this->nowblock.color=0xffffff;
        break;
    case 3:///V
        this->nowblock.numofbk=4;
        this->nowblock.points[0]= { 0, 0, 0};
        this->nowblock.points[1]= { 0, 0, 1};
        this->nowblock.points[2]= { 0, 1, 0};
        this->nowblock.points[3]= { 1, 0, 0};
        this->nowblock.color=0xffffff;
        break;
    case 4:///Z
        this->nowblock.numofbk=4;
        this->nowblock.points[0]= { 0, 0, 0};
        this->nowblock.points[1]= { 0, 1, -1};
        this->nowblock.points[2]= { 0, 0, -1};
        this->nowblock.points[3]= { -1, 0, 0};
        this->nowblock.color=0xffffff;
        break;
    case 5:///S
        this->nowblock.numofbk=4;
        this->nowblock.points[0]= { 0, 0, 0};
        this->nowblock.points[1]= { 0, 1, 0};
        this->nowblock.points[2]= { 0, 0, -1};
        this->nowblock.points[3]= { -1, 0, -1};
        this->nowblock.color=0xffffff;
        break;
    case 6:///D
